package cn.imhtb.ad.sender.impl;

import cn.imhtb.ad.index.CommonStatus;
...
public class SearchImpl implements ISearch {
    ...
    public SearchResponse fetchAds(SearchRequest request) {
        ...
        for (AdSlot adSlot : adSlots) {
            ...
            List<CreativeObject> creative = DataTable.of(CreativeIndex.class)
                    .fetch(adIds);
            ...
            adSlot2Ads.put(
                    adSlot.getAdSlotCode(), buildCreativeResponse(creative)
            );
        }
